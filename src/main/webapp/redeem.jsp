				...
				$('#redeem').click(
						function() {
							...
							if (code == "") {
								...
								var text = "<p>Coupon code can't be empty</p>";
								...
								.ajax({
									type : "PUT",
									url : "/shan-pizza/rest/coupons/redeem/"+code,
									success : function(
											data) {
										tmp = data;
										$('#result')
	...
	<div class="container">
		...
		<div class="jumbotron"
			...
			<p>
				...
				<textarea class="form-control" rows="1" id="code"
			...
			<div id="processing-pannel" style="display: none;">
				<div id="spinner" style="display: none;">
					<strong>A request to Redeem coupon has already been made. Please
